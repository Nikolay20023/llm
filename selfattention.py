...
class SelfAteentionV2(nn.Module):
...
class CausalAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        conext_vector = attn_weights @ values

        return conext_vector 
...
class MultiHeadAttention(nn.Module):
    def __init__(self, d_in, d_out,
        ...
        assert (d_out % num_heads == 0 ), \
            "d_ost must be divisible by num_heads"
